        ...
        >
            ...
            {typeof cityTemp.main != 'undefined' ? (
                <div className="cityCard">
                    ...
                    <p>
                        Temperature :{' '}
                        {Math.floor(cityTemp.main ? cityTemp.main.temp : null) -
                            273}
                        °c
                    </p>
                    <p>
                        Temp max :{' '}
                        {Math.floor(
                            cityTemp.main ? cityTemp.main.temp_max : null
                        ) - 273}
                        °c
                    </p>
                    <p>
                        Temp min :{' '}
                        {Math.floor(
                            cityTemp.main ? cityTemp.main.temp_min : null
                        ) - 273}
                        °c
                    </p>
                    <button className="favorites-btn" onClick={setFavorite}>
                        addfavorite
                    </button>
                </div>
            ) : (
